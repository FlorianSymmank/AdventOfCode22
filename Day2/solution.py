""" Solves Day Two of  Advent of Code 2022 https://adventofcode.com/2022/day/2 """
...
# a winner for that round is selected: Rock defeats Scissors, Scissors defeats Paper,
...
def tournament_score() -> int:
    """ calculates score of given playbook"""
    # Rock A X
    # Paper B Y
    # Scissors C Z
    ...
    score = 0
    with open("day2/input1.txt", encoding="UTF-8") as file:
...
print("tournament_score: ", tournament_score())
...
print("tournament_score2: ", tournament_score2())
